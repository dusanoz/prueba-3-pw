...
urlpatterns = [
    ...
    path('lista_detalle_ventas', lista_detalle_ventas,
         name="lista_detalle_ventas"),
    ...
    path('detalle_venta/<id_detalle_venta>',
         detalle_venta, name="detalle_venta"),
    path('detalle_medio_pago/<id_medio_pago>',
         detalle_medio_pago, name="detalle_medio_pago"),
]
